				...
				<div class="dataTables_wrapper">
								<div class="row">
									...
									<div class="col-md-12 col-sm-12">
										<label>
											会员帐号：
											<input id="appUserMobile" type="text"  class="form-control input-inline" placeholder="手机号" />
...
jQuery(document).ready(function() {    
	...
	table = $('#sample_1').DataTable({
		...
		"scrollY":false,
		ajax: {
            url: "memberListAjax.shtml",
            	"data": function ( d ) {
          				d.appUserMobile=$("#appUserMobile").val();
                }
        },
        serverSide: true,
        columns: [
