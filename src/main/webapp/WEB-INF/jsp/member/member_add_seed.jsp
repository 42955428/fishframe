						...
						<div class="portlet-body form">
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" size="16" class="form-control" name="regCode" value="${user.userId}">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="password" size="16" class="form-control" name="password" value="${user.loginPwd}">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" size="16" class="form-control" name="regName" value="${user.loginName}">
										<span id="regNameSpanMsg" class="alert-danger"></span>
									</div>
								</div>
								<!-- 
